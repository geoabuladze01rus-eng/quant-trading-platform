...
REASON_CATALOG = MappingProxyType({
    ...
    "hedge_required": "Обнаружен остаточный риск. Требуется защитное учебное хеджирование.",
    "protective_hedge_failed": (
        "Защитное учебное хеджирование не выполнено. Новые операции остановлены."
    ),
    "recovery_reset": "Оператор явно восстановил учебный execution runtime.",
})
